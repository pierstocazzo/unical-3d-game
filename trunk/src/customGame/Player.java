...
/**
 * Vehicle_ will be a node that handles the movement of a vehicle in the
...
//  temporary vector for the rotation
     ...
     */
    public Player(String id, Spatial model, float maxSpeed, float minSpeed,
