...
public class CollisionDetection{
    ...
    public void ProcessCollisions() {
    	if (NextMove == BounceOff){//se la collisione � a rimbalzo
               if (player.hasCollision(target, false)){
        		...
        		if (player.frontwheel.hasCollision(target, false)){
        			player.setVelocity(-Math.abs(player.getVelocity()));//inverto velocit�
        			if (player.getVelocity() > -0.5)//porto la velocit� ad un minimo fissato
