 ...
 * verr� gestito il movimento attraverso un inputHandler customizzato 
 * e soprattutto verr� creata la chase camera che serve a noi!
 * propriet� della camera:
 * punta sempre al nostro player e lo inseguir� (senno perch� chase!)
 * da libert� di rotazione col mouse attorno al player
...
//		application.setConfigShowMode(ConfigShowMode.AlwaysShow, Game2.class.getClassLoader().getResource( "images/openGame.jpg" ));
	...
	protected void initGame() {
		...
		// un CullState � in pratica un modo per velocizzare il tutto, visto la dovr� girare su una vm
