...
public class ExplosionTest extends SimplePhysicsGame{
	...
	protected void simpleInitGame() {
        ...
        // creo il mio pavimento, un box (dimensioni default (1,1,1)) attaccato al nodo statico
...
//        // creo un gruppo di nodi dinamici 
...
//		        }
		...
		exp.setStartColor( new ColorRGBA(ColorRGBA.red) );
