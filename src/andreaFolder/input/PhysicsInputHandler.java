...
import andreaFolder.graphics.PhysicsCharacter;
import andreaFolder.input.action.LookAtAction;
import andreaFolder.input.action.PhysicsBackwardAction;
import andreaFolder.input.action.PhysicsForwardAction;
import andreaFolder.input.action.PhysicsJumpAction;
import andreaFolder.input.action.PhysicsStrafeLeftAction;
import andreaFolder.input.action.PhysicsStrafeRightAction;
